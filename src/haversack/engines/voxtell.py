...
and those masks may overlap ("liver" and "liver tumor"). haversack's Segmentation carries
...
def normalize_prompts(prompts) -> list[str]:
    ...
    Raises :class:`~haversack.errors.InputError` on an empty or malformed prompt list -
