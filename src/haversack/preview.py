...
:func:`haversack.io.orientation_transform` - the same DICOMOrient probe the
...
def display_planes(gray, lab, geometry, *, display: str = DISPLAY) -> list:
    ...
    :class:`haversack.values.Geometry`, any orientation). For each panel the
    ...
    flip: the permutation comes from :func:`haversack.io.orientation_transform`,
