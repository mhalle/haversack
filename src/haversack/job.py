...
class Job:
    ...
    def __init__(self, fn, *, device="auto", on_progress=None, name: str = "segment"):
        ...
        self._thread = threading.Thread(target=self._run, args=(fn,), name=f"haversack-{name}", daemon=True)
        self._thread.start()
    ...
    def result(self, timeout: float | None = None):
        """The :class:`~haversack.result.Segmentation`, re-raising whatever the run raised."""
