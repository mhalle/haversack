...
Every number here is checked against `haversack.phantoms`, whose truth is closed form or
...
class TestAccuracy(unittest.TestCase):
    ...
    def test_the_stored_form_is_free_for_volume_and_biases_area_low(self):
        """The asymmetry, measured. Clip and the support byte cost the volume nothing;
        ...
        of magnitude better than counting, but not a neutral measurement. (For one release
        this test believed the log byte had made area free: it was reading rankfield
        0.1.0's margin, which put lone winners at 64 logits instead of the clip.)"""
        g = _grid()
        losses = []
