...
from haversack.envelope import Envelope, body_mask, envelope_of, margin_in_voxels
...
def test_label_roi_boxes_the_requested_classes():
    from haversack.envelope import label_roi
...
def test_otsu_splits_a_bimodal_histogram_between_the_modes():
    from haversack.envelope import otsu_threshold
...
def test_body_threshold_ct_matches_the_hu_formula():
    from haversack.envelope import body_threshold, AIR_HU
...
def test_body_threshold_mr_is_data_driven_and_crops_the_blob():
    ...
    from haversack.envelope import body_threshold, body_mask, envelope_of
...
def test_body_threshold_mr_ignores_stray_ct_properties():
    ...
    from haversack.envelope import body_threshold
